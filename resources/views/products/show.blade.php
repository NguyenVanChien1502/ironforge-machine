<x-app-layout :title="$product->title . ' — Hồ Nam Landscape'">
    <section class="bg-gray-50 py-16">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <nav class="mb-8 text-sm text-gray-500">
                <a href="{{ route('home') }}" class="hover:text-gold">Trang chủ</a> /
                <a href="{{ route('products.index') }}" class="hover:text-gold">Dự án</a> /
            ...
            <div class="grid grid-cols-1 gap-12 lg:grid-cols-2">
                ...
                <div>
                    ...
                    @if($product->model_number)
                        <p class="mt-2 text-sm text-gray-500">Mã dự án: {{ $product->model_number }}</p>
                    @endif
                    ...
                    <a href="#inquire" class="btn-secondary mt-8">Yêu cầu báo giá cho dự án này</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="inquire" class="bg-charcoal py-20">
        <div class="mx-auto max-w-2xl px-6 lg:px-8">
            <h2 class="text-center text-2xl font-extrabold text-white">Gửi yêu cầu cho {{ $product->title }}</h2>
            ...
            <form method="POST" action="{{ route('inquiries.store') }}" class="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    <label class="label !text-gray-300">Nội dung</label>
    ...
    @if($relatedProducts->isNotEmpty())
        <section class="bg-gray-50 py-16">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <h2 class="section-heading mb-10">Dự án liên quan</h2>
                    ...
                    @foreach($relatedProducts as $related)
                        <div class="card overflow-hidden">
                            ...
                            <div class="p-5">
                                ...
                                <a href="{{ route('products.show', $related) }}" class="mt-3 inline-block text-sm font-semibold text-charcoal hover:text-gold">Xem chi tiết &rarr;</a>
                            </div>
                        </div>
                    @endforeach
                </div>
