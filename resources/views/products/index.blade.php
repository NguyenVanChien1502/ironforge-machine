<x-app-layout>
    <section class="border-b border-gray-100 bg-charcoal py-16">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <h1 class="text-3xl font-extrabold text-white sm:text-4xl">Products & Equipment</h1>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mb-10 flex flex-wrap gap-3">
                <a href="{{ route('products.index') }}"
                   class="rounded-full px-5 py-2 text-sm font-medium transition {{ request('category') ? 'bg-white text-charcoal ring-1 ring-gray-200' : 'bg-charcoal text-white' }}">All</a>
